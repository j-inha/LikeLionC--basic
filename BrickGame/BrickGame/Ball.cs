...
namespace BrickGame
{
    public class Ball
    {
        ...
        public void ScreenWall()
        {
            ...
            Program.gotoxy(0, 0);
            Console.Write("┏━━━━━━━━━ ۞¸,ø¤º°°º¤ø,¸¸,ø¤º°☆꧁༒☬ BrickGame ☬༒꧂☆°º¤ø,¸¸,ø¤º°°º¤ø,¸۞━━━━━━━━━━┓");
            Program.gotoxy(0, 1);
            Console.Write("┃                                                                             ┃");
            Program.gotoxy(0, 2);
            Console.Write("┃                                                                             ┃");
        ...
        public void Progress()
        {
            if (m_tBall.nReady == 0) //0 움직임
            {
                ...
                {
                    case 0: if (Collision(m_tBall.nX, m_tBall.nY - 1) == 0) m_tBall.nY--; break; //UP
                    case 1: if (Collision(m_tBall.nX + 1, m_tBall.nY - 1) == 0) m_tBall.nX++; m_tBall.nY--; break; //Right up
                    case 2: if (Collision(m_tBall.nX + 1, m_tBall.nY + 1) == 0) m_tBall.nX++; m_tBall.nY++; break; //Right down
                    case 3: if (Collision(m_tBall.nX, m_tBall.nY + 1) == 0) m_tBall.nY++; break; //Down
                    case 4: if (Collision(m_tBall.nX - 1, m_tBall.nY + 1) == 0) m_tBall.nX--; m_tBall.nY++; break; // Left down
                    case 5: if (Collision(m_tBall.nX - 1, m_tBall.nY - 1) == 0) m_tBall.nX--; m_tBall.nY--; break; // Left up
                }
